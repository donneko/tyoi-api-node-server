export const ERROR_CODE_2XX = [
    ...
    },
    {
        ...
        message: "Accepted",
        description:
            "The request has been accepted for processing, but the processing has not been completed. The request might or might not eventually be acted upon, and may be disallowed when processing occurs.",
        label: "http",
    },
    {
        code: 203,
